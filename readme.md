...
```
> Compiling 'test/test.bf'...  
> bf!

Brainiac does not yet read files and the compilation stage is unimplemented.
The output is produced from procedurally generated bytecode.
